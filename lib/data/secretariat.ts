...
export const SECRETARIAT: Officer[] = [
  ...
  // Beginner tier
  { id: "eb-unhrc-parthajyoti", name: "Parthajyoti Roy", role: "Co-Chair", committee: "UNHRC", group: "Executive Board" },
  { id: "eb-unhrc-srotoswini", name: "Srotoswini Ghatak", role: "Co-Chair", committee: "UNHRC", group: "Executive Board" },
  { id: "eb-uncsw-namrata", name: "Namrata Mishra", role: "Co-Chair", committee: "UNCSW", group: "Executive Board" },
  { id: "eb-uncsw-ahanjit", name: "Ahanjit Paul", role: "Co-Chair", committee: "UNCSW", group: "Executive Board" },
  { id: "eb-specpol-akashdeep", name: "Akashdeep Sen", role: "Co-Chair", committee: "SPECPOL", group: "Executive Board" },
  { id: "eb-specpol-aryan", name: "Aryan Banerjee", role: "Co-Chair", committee: "SPECPOL", group: "Executive Board" },
  { id: "eb-ipc-drishti", name: "Drishti Kedia", role: "Chairperson", committee: "IPC", group: "Executive Board" },
  { id: "eb-ipc-priyansha", name: "Priyansha Paul", role: "Chairperson", committee: "IPC", group: "Executive Board" },
  { id: "eb-ipc-avi", name: "Avi Kathpalia", role: "Chairperson", committee: "IPC", group: "Executive Board" },
  // Intermediate tier
  ...
  { id: "eb-unodc-sanchayan", name: "Sanchayan Chakraborty", role: "Vice Chair", committee: "UNODC", group: "Executive Board" },
  { id: "eb-brics-utsav", name: "Utsav Dey", role: "Chairperson", committee: "BRICS", group: "Executive Board" },
  { id: "eb-ccpa-shounak", name: "Shounak Banarjee", role: "Chairperson (PM Modi)", committee: "CCPA", group: "Executive Board" },
  { id: "eb-ls-aaron", name: "Aaron Mirza", role: "Co-Moderator", committee: "Lok Sabha", group: "Executive Board" },
  { id: "eb-ls-sapnil", name: "Sapnil Biswas", role: "Co-Moderator", committee: "Lok Sabha", group: "Executive Board" },
  // Advanced tier
  { id: "eb-icj-ayush", name: "Ayush Majumder", role: "President", committee: "ICJ", group: "Executive Board" },
  { id: "eb-icj-shourjo", name: "Shourjo Roy Chaudhuri", role: "Registrar", committee: "ICJ", group: "Executive Board" },
  { id: "eb-unsc-ctc-riddhi", name: "Riddhi Sen Majumder", role: "Chairperson", committee: "UNSC-CTC", group: "Executive Board" },
  { id: "eb-1962-ccc-rutajeet", name: "Rutajeet Karmarkar", role: "Co-Chair", committee: "1962-CCC", group: "Executive Board" },
  { id: "eb-1962-ccc-tenzing", name: "Tenzing Namgyal Bhutia", role: "Co-Chair", committee: "1962-CCC", group: "Executive Board" },
  // Flagship tier
  { id: "eb-hlpf-sankalpa", name: "Sankalpa Chakraborty", role: "Chairperson", committee: "HLPF", group: "Executive Board" },
  { id: "eb-hlpf-nikhil", name: "Nikhil Mohan", role: "Vice Chair", committee: "HLPF", group: "Executive Board" },
  { id: "eb-copuos-dipankar", name: "Dipankar Kunwar", role: "Chairperson", committee: "COPUOS", group: "Executive Board" },
